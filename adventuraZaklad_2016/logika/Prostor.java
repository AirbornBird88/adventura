...
public class Prostor {
    ...
    //additional methods for klic (getter, setter)
    ...
    //additional methods for Dostuony atribut
    public boolean jeDostupny() {
        return dostupny;
    }

    public void dostupnost(boolean dostupny) {
    ...
    public Vec vratVeci(String nazevVeci) {
